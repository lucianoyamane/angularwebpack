...
module.exports = function () {
  ...
  const METADATA = buildUtils.updateMetadata({
    host: parametrosWebPack.dev.server.host,
    port: parametrosWebPack.dev.server.port,
    env: parametrosWebPack.dev.env,
    PUBLIC: parametrosWebPack.dev.server.public
  });

  return webpackMerge(commonConfig(METADATA), {
    mode: parametrosWebPack.dev.env,
    /**
